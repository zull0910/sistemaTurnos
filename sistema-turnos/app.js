// // // Este código solo se ejecutará en la página de control (index.html)
...
// //     // Inicializamos el Broadcast Channel para la comunicación entre pestañas
// //     const channel = new BroadcastChannel('sistema_turnos_channel');
    
// //     // Función para el llamado por voz
...
// //     // Evento para el botón de "Llamar"
...
// //         const turno = {
// //             id: Date.now(), // Un ID único para cada turno
// //             nombre: nombre,
// //             consultorio: consultorio,
// //             sede: sede
// //         };

// //         // Enviar el turno a través del Broadcast Channel
// //         channel.postMessage({
// //             type: 'nuevo_llamado',
// //             data: turno
// //         });
...
// //         // Llamada por voz
// //         const mensajeVoz = `Atención, por favor. El paciente ${nombre}, debe pasar al consultorio ${consultorio} de la sede ${sede}.`;
// //         llamarPorVoz(mensajeVoz);

// //         // Limpiar el campo de nombre para el siguiente llamado
// //         nombreInput.value = '';
// //     });

// //     // En el siguiente paso, implementaremos la lógica para cancelar y atender
// //     // también agregaremos la vista de la pantalla para los pacientes.

// //     // --- Código para la Vista de Visualización (pantalla.html) ---
// // if (window.location.pathname.includes('pantalla.html')) {

// //     const listaTurnos = document.getElementById('lista-turnos');
// //     const channel = new BroadcastChannel('sistema_turnos_channel');

// //     // Función para crear y mostrar una tarjeta de turno
// //     function mostrarTurno(turno) {
// //         const turnoElement = document.createElement('div');
// //         turnoElement.classList.add('turno-card');
// //         turnoElement.innerHTML = `
// //             <p><strong>Paciente:</strong> ${turno.nombre}</p>
// //             <p><strong>Consultorio:</strong> ${turno.consultorio}</p>
// //             <p><strong>Sede:</strong> ${turno.sede}</p>
// //         `;
// //         listaTurnos.prepend(turnoElement); // Usa prepend para que el turno más reciente aparezca arriba
// //     }

// //     // Escuchar mensajes del Broadcast Channel
// //     channel.addEventListener('message', (event) => {
// //         if (event.data.type === 'nuevo_llamado') {
...
// // Si los elementos de la vista de control existen, activamos su lógica
// if (llamarBtn && nombreInput && consultorioSelect && sedeSelect) {
...
//     // Lógica futura para los botones de Cancelar y Atender
...
// // Si el elemento de la vista de pantalla existe, activamos su lógica
// if (listaTurnos) {
//     // Función para crear y mostrar una tarjeta de turno
//     function mostrarTurno(turno) {
//         const turnoElement = document.createElement('div');
...
//             <p><strong>Sede:</strong> ${turno.sede}</p>
//         `;
//         listaTurnos.prepend(turnoElement);
//     }
